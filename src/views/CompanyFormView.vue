      ...
      <div>
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb mb-1">
            ...
            <li class="breadcrumb-item active">{{ isEditing ? 'Edição' : 'Cadastro' }}</li>
          </ol>
        </nav>
        <h2 class="fw-bold d-flex align-items-center gap-2">
          <component :is="isEditing ? SquarePen : PlusCircle" :size="26" class="text-primary" />
    ...
    <div class="card shadow-sm border-1">
      <div class="card-body p-4">
        <form @submit.prevent="handleSubmit">
          <div class="row g-3">
            <div class="col-md-8">
              <label for="name" class="form-label fw-semibold">Nome da Empresa <span class="text-danger">*</span></label>
              <input 
                id="name"
                v-model="form.name"
                type="text"
            ...
            <div class="col-12 mt-4">
              <div class="form-check form-switch p-0 d-flex align-items-center gap-3">
                <label class="form-check-label fw-semibold" for="status">Status da Empresa</label>
                <input 
